...
Now, the formal definition of similar types in the standard is pretty complicated (I had to take a second look), but cppreference gives a nice summary in [this section](https://en.cppreference.com/w/cpp/language/implicit_conversion#Similar_types):  
